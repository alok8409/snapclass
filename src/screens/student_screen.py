...
def student_dashboard():
    ...
    with st.spinner('Loading your enrolledsubjects...'):
        ...
        with st.spinner('AI is scanning..'):
            ...
            if num_faces == 0:
                ...
                if detected:
                    ...
                    st.info('Face not recognize! You might be a new student!')
                    show_registration = True
    if show_registration:
        with st.container(border=True):
            st.header('Register new Profile')
            new_name = st.text_input("Enter your name", placeholder='eg : Alok Singh')
