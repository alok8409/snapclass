...
def teacher_tab_manage_subjects():
    ...
    if subjects:
        ...
        st.info("No subjects found. Please create a new subject.")
...
def teacher_tab_attendance_records():
    ...
    for r in records:
        ...
        data.append({
            ...
            "Time": datetime.fromisoformat(ts).strftime("%Y-%m-%d %H:00") if ts else "N'A",
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='eg : @xyz123')

    teacher_pass = st.text_input("Enter password", placeholder='eg : xyz@123', type='password')
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder='eg : @xyz121')

    teacher_name = st.text_input("Enter name", placeholder='eg : xyz')

    teacher_pass = st.text_input("Enter password", placeholder='eg : xyz@123', type='password')

    teacher_pass_confirm = st.text_input("Confirm your password", placeholder='Enter password again', type='password')
